...
GENRB_SOURCE = af.txt af_NA.txt af_ZA.txt agq.txt\
 ...
 cgg.txt cgg_UG.txt chr.txt chr_US.txt ckb.txt\
 ckb_IQ.txt ckb_IR.txt cs.txt cs_CZ.txt cy.txt\
 cy_GB.txt da.txt da_DK.txt da_GL.txt dav.txt\
 dav_KE.txt de.txt de_AT.txt de_BE.txt de_CH.txt\
 de_DE.txt de_IT.txt de_LI.txt de_LU.txt dje.txt\
